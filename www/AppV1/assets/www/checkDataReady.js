  ...
  switch(type)
		{
      	    /*CALL*/
      	    case 2:
      	       var ur2 = rootURI + 'record/' + uid + '/'+ '2/' + encodeURIComponent(time) + '/' + currLat + '/' + currLon + '/' + ax + '/' + ay + '/' + az + '/' + phoneNumber + '/' + time + '/' + null + '/' + null;
      	       //alert(ur2);
      	       doRequest(ur2,0);      	       
      	    break;
      	    ...
      	    /*MSG*/
      	    case 3:
      	       var ur3 = rootURI + 'record/' + uid + '/'+ '3/' + encodeURIComponent(time) + '/' + currLat + '/' + currLon + '/' + ax + '/' + ay + '/' + az + '/' + null;
      	       doRequest(ur3,0);
      	    break;
